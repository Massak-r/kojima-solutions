...
export const CAPTURE_KINDS: CaptureKindMeta[] = [
  ...
  // Not a triage category: a note addressed to the assistant, surfaced to it at
  // the start of every session and closed by it rather than by the founder.
  { kind: "claude", emoji: "🤖", label: "Claude", badge: "bg-amber-100 text-amber-800 dark:bg-amber-500/15 dark:text-amber-300" },
];
