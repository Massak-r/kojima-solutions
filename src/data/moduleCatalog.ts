...
export const MODULE_CATALOG: ModuleDefinition[] = [
  ...
  },
  {
    ...
    icon: "Database",
    category: "system",
    description: "Structure de données sur-mesure — adaptation d'un schéma existant ou création de zéro",
    tiers: [
      {
        complexity: "simple",
        label: "Simple",
        description: "Adaptation structure existante",
        price: 500,
        estimatedHours: 4,
        features: ["Reprise du schéma existant", "Tables et relations de base", "Index standards", "Documentation"],
      },
      {
        complexity: "advanced",
        label: "Avancé",
        description: "Schéma sur-mesure (from scratch)",
        price: 1200,
        estimatedHours: 10,
        features: ["Modélisation complète", "Relations et contraintes", "Migrations versionnées", "Optimisation des requêtes", "Sauvegardes"],
      },
      {
        complexity: "custom",
        label: "Sur mesure",
        description: "Architecture avancée",
        price: 3500,
        estimatedHours: 26,
        features: ["Architecture spécialisée", "Partitionnement / sharding", "Audit de performance", "Haute disponibilité", "Plan de reprise"],
      },
    ],
    taskTemplates: [
      { title: "Modélisation des données", description: "Conception et documentation du schéma", subtasks: ["Analyse des entités", "Relations et contraintes", "Normalisation", "Documentation schéma"] },
      { title: "Implémentation base de données", description: "Création et migration de la structure", subtasks: ["Création des tables", "Index et clés", "Migrations / seed", "Sauvegarde & restauration"] },
    ],
    quoteLineDescription: "Base de données",
