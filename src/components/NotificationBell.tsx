      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-[calc(100vw-1rem)] max-w-sm sm:w-96 sm:max-w-none glass-card rounded-xl border border-border shadow-xl overflow-hidden z-50"
          >
            {/* Header */}
